...
<header class="content_top">
	<h2 style="font-size: x-large;">결재 예정 문서함</h2>
	...
	<div class="dataTables_wrapper">
		...
		<ul class="nav nav-tabs" role="tablist">
			<li role="presentation" class="active"><a
				class="nav-link active" role="tab" aria-controls="#Cancledboard1"
				data-toggle="tab" href="#Applicant">전체</a></li>
		</ul>
		<div class="tab-content">
			<div role="tabpanel" class="tab-pane active" id="Cancledboard1">
					<!-- 전체 결재 대기 문서 테이블  -->
							...
							<c:when test="${empty dblist}">
								...
								<td colspan="7">
									<p class="data_null">
										...
										<span class="txt">결재 예정 문서가 없습니다.</span>
									</p>
								</td>
								</tr>
							</c:when>
