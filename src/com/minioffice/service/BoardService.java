...
public class BoardService {
	...
	public com.minioffice.vo.PageBean<Board> boardList(int currentPage, String boardType)throws NotFoundException {
		int cntPerPage = 20;	//페이지당 보여줄 목록
		int startRow = 1+ (currentPage-1)*cntPerPage;	//첫 행
		int endRow = currentPage*cntPerPage;			//마지막 행
		int cntPerPageGroup = 2;						//홯면에 보여줄 페이지수
		String type = boardType;
		List<Board> list = boarddao.boardlist(startRow,endRow, type);
